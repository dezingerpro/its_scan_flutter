...
class InitMiqaat extends StatefulWidget {
  @override
  _InitMiqaatState createState() => _InitMiqaatState();
}

class _InitMiqaatState extends State<InitMiqaat> {
          ...
          children: [
            ...
            DropdownButtonFormField<Map<String, dynamic>>(
              ...
              onChanged: (selectedMiqaat) {
                selectedMiqaatId = selectedMiqaat?['miqaat_id'];
                // Navigate to InitializeEventPage with the selected Miqaat's details
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => InitMiqaatInternational(
