...
import '../../api.dart';
import 'central_gate_assingment.dart';
import '../../secretary/gate_assingment.dart';

class InitMiqaatInternational extends StatefulWidget {
  final String selectedEvent;
  final int eventId;
  const InitMiqaatInternational({super.key, required this.selectedEvent,required this.eventId});

  @override
  _InitMiqaatInternationalState createState() => _InitMiqaatInternationalState();
}

class _InitMiqaatInternationalState extends State<InitMiqaatInternational> {
  ...
  Future<void> _assignMembersToMiqaat() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GateAssignmentIntPage(memberIds: selectedMembers, eventId: widget.eventId),
      ),
    );
    // try {
